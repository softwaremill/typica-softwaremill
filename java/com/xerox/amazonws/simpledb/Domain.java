...
//						}
	...
	public SDBResult replaceAttributes(String identifier, Map<String, Set<String>> attributes, List<Condition> conditions) throws SDBException {
		...
		if (cache != null) {
			...
			if (old != null) {
                ...
                for (Map.Entry<String, Set<String>> oldAttributesEntry : old.getAttributes().entrySet()) {
                    if (!attrs.containsKey(oldAttributesEntry.getKey())) {
                        attrs.put(oldAttributesEntry.getKey(), oldAttributesEntry.getValue());
                    }
                }
			}
			// place/replace item in cache
	...
	public Result<Item> getItem(String identifier) throws SDBException {
        return getItem(identifier, false);
    }
	 ...
	 * @throws SDBException wraps checked exceptions
	 */
	public Result<Item> getItem(String identifier, boolean consistent) throws SDBException {
		if (cache != null) {
